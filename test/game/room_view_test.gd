...
func _snapshot() -> Dictionary:
	return {
		...
		"seats": [
			...
			{"number": 3, "color": Color.BLUE, "is_npc": true},
		],
	}
...
func test_시작할_수_없으면_시작_버튼이_잠긴다() -> void:
	...
	_room_view.render(cannot_start)
